...
def main():
    ...
    "# Exposed AWS keys (https://www.google.com/search?q=site%3A"+domain+"+%22AWS_ACCESS_KEY_ID%22+%7C+%22AWS_SECRET_ACCESS_KEY%22)": "site:"+domain+" \"AWS_ACCESS_KEY_ID\" | \"AWS_SECRET_ACCESS_KEY\"",
    "# Exposed Google API keys (https://www.google.com/search?q=site%3A"+domain+"+%22AIza%22+%7C+%22AIzaSy%22)": "site:"+domain+" \"AIza\" | \"AIzaSy\"",
    "# Exposed passwords (https://www.google.com/search?q=site%3A"+domain+"+intext%3Apassword+%7C+intext%3Apass+%7C+intext%3Apasswd)": "site:"+domain+" intext:password | intext:pass | intext:passwd",
    "# Exposed SSH keys (https://www.google.com/search?q=site%3A"+domain+"+%22BEGIN+RSA+PRIVATE+KEY%22+%7C+%22BEGIN+DSA+PRIVATE+KEY%22)": "site:"+domain+" \"BEGIN RSA PRIVATE KEY\" | \"BEGIN DSA PRIVATE KEY\"",
    "# Exposed database credentials (https://www.google.com/search?q=site%3A"+domain+"+intext%3A%22db_password%22+%7C+intext%3A%22db_user%22)": "site:"+domain+" intext:\"db_password\" | intext:\"db_user\"",    
    }
