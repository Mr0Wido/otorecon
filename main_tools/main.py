...
from main_tools.full_scan import full_scan
...
def parser_arguments():
    ...
    parser.add_argument('-subs', '--subdomain_scan',help = 'Specify subdomain tools to run or use "all" to run all tools',nargs = '*', choices = ['sublist3r', 'subfinder', 'assetfinder',  'findomain', 'crtsh','theharvester', 'shuffledns', 'dnsgen', 'wfuzz', 'altdns', 'all'], default=None)
    ...
    parser.add_argument('-cs', '--crawler_scan', help='Pulling URLs from crawler tools', nargs='*', choices = ['crawler' , 'waymac', 'cocrawl', 'waybackurl', 'archive','gau', 'getJS', 'katana', 'cariddi', 'hakrawler', 'golinkfinder', 'all'], default=None)
